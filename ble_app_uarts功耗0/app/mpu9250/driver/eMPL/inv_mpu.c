...
#define i2c_write   nrf_drv_mpu_write_registersd
#define i2c_read    nrf_drv_mpu_read_registersd
...
const struct test_s test = {
    ...
    .sample_wait_ms = 2    //10ms sample time wait
};
...
//		q3 = quat[3] / q30; 
//		
//		printf("%f %f %f %f %d %d %d\r\n",q0,q1,q2,q3,compass_short[0],compass_short[1],compass_short[2]);

		quater[0] = quat[0] / q30;	//q30格式转换为浮点数
		quater[1] = quat[1] / q30;
		quater[2] = quat[2] / q30;
		quater[3] = quat[3] / q30; 
